...
- (void)testReturnObject {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testReturnObject)]);
	obj.delegate = dd;
...
- (void)testReturnStruct {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testReturnStruct)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassObject {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithObject:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassChar {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithChar:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassUChar {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithUChar:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassShort {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithShort:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassUShort {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithUShort:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassInt {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithInt:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassUInt {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithUInt:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassLong {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithLong:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassULong {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithULong:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassLongLong {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithLongLong:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassULongLong {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithULongLong:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassFloat {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithFloat:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassDouble {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithDouble:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassArray {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testWithArray:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testPassStruct {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForMethod:@selector(testPassStruct:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testClassMethod {
	...
	XCTAssertNotNil(dd, @"%@", [dd blockImplementationForClassMethod:@selector(testWithObject:)]);
	obj.delegate = dd;
	BOOL result = [obj test];
	XCTAssertTrue(result, @"Test object didn't return true");
}
...
- (void)testClassInterfacing {
	...
	XCTAssertEquals([interposed class], [original class], @"Classes not the same");
	XCTAssertEquals([interposed hash], [original hash], @"Hashes not the same");
	XCTAssertEquals([interposed superclass], [original superclass], @"Superclasses not the same");
}
